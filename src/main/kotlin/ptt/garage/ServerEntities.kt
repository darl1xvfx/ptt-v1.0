...
import ptt.client.WeaponVisual
...
class ServerGarageItemPaint(
  ...
  @Json val coloring: Int? = null,
  @Json val animatedColoring: Int? = null,
...
data class Health(@Json val maxHealth: Double? = 1000.0)
...
class ServerGarageItemHullModification(
  ...
  @Json val maxHealth: Health = Health(maxHealth = 1000.0)
) : ServerGarageItemModification(previewResourceId, object3ds, rank, price, properties, physics)
