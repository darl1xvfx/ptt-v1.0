...
enum class BonusType(val mapKey: String, val bonusKey: String, val id: Int) {
  ...
  Gold("gold", "gold", 6),
  GoldKilled("goldkilled", "goldkilled", 7);
...
data class ServerMapInfo(
  ...
  @Json val highDeathZone: Int? = null,
  @Json val lowerDeathZone: Int? = null,
...
enum class ServerMapTheme(val key: String, val clientKey: String, val visualKey: String) {
  ...
  Evening("evening", clientKey = "EVENING", visualKey = "EVENING"),
  Halloween("halloween", clientKey = "HALLOWEEN", visualKey = "HALLOWEEN"),
