...
import ptt.client.weapons.twins_xt.Fire
import ptt.client.weapons.twins_xt.FireStatic
import ptt.client.weapons.twins_xt.FireTarget
import ptt.commands.Command
import ptt.commands.CommandName
import ptt.garage.ServerGarageUserItemWeapon
import kotlin.random.Random

class Twins_XTWeaponHandler(
  player: BattlePlayer,
  ...
  suspend fun fireTarget(target: FireTarget) {
    ...
    val randomDamage = random.nextInt(187, 263).coerceAtMost(263).toDouble()
