...
import ptt.ServerIdResource
import ptt.extensions.gitVersion
import ptt.utils.ResourceUtils
...
class ResourceServer : IResourceServer, KoinComponent {
  ...
  val client = HttpClient(CIO) {
    install(DefaultRequest) {
      headers {
        set(HttpHeaders.UserAgent, "ptt Server/${ptt.BuildConfig.gitVersion}")
      }
    }
  }
  ...
  private fun getNotFoundBody(resourceId: ServerIdResource, file: String) = """
    ...
    |  <hr />
    |  <h4><a href="https://github.com/Assasans/ptt-server" target="_black" rel="noopener">ptt-server</a>, ${ptt.BuildConfig.gitVersion}</h4>
    |</body>
    |</html>
  """.trimMargin()
