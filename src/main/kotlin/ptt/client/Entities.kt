...
import ptt.garage.HullPhysics
import ptt.garage.WeaponPhysics
import ptt.serialization.SerializeNull
...
fun List<BattlePlayer>.toStatisticsUsers(): List<StatisticsUserData> {
  return map { player ->
    StatisticsUserData(
      ...
      chatModeratorLevel = player.user.chatModerator
    )
  }
}
