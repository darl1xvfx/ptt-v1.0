...
class Railgun_TERMINATOR_EVENTVisual(
  @Json val chargingPart1: Int,
  @Json val chargingPart2: Int,
  @Json val chargingPart3: Int,
...
class Ricochet_HAMMER_XTVisual(
  @Json val bumpFlashTexture: Int,
